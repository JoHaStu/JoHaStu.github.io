    ...
    <div>
        <div id="sessnavdiv" class="nav_menu">
          <div class="columnA">
           ...
           <button class="buttons" @click="searchPosts(searchword)">Search</button>
           <button class="buttons" v-on:click="goAddPost()">Add a Post</button>
          </div>
          <div class="columnB">
    ...
    export default {
      ...
      methods:{
        ...
        searchPosts(searchword){
          ...
          axios.get("/api/searchPosts", params)
          .then((response) =>
          {
